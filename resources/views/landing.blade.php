                        ...
                        <div class="swiper-slide">
                            <div class="blog-post-item">
                                ...
                                <div class="blog-post-content">
                                    ...
                                    <h2><a href="#">Neque porro quisquam est qui dolorem ipsum quia dolor sit
                                            amet</a></h2>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-post-item">
                                ...
                                <div class="blog-post-content">
                                    ...
                                    <h2><a href="#">Sed ut perspiciatis unde omnis iste natus error sit
                                            voluptatem</a></h2>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-post-item">
                                ...
                                <div class="blog-post-content">
                                    ...
                                    <h2><a href="#">At vero eos et accusamus et iusto odio dignissimos
                                            ducimus</a></h2>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-post-item">
                                ...
                                <div class="blog-post-content">
                                    ...
                                    <h2><a href="#">Et harum quidem rerum facilis est et expedita distinctio</a>
                                    </h2>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-post-item">
                                ...
                                <div class="blog-post-content">
                                    ...
                                    <h2><a href="#">Nam libero tempore, cum soluta nobis est eligendi optio</a>
                                    </h2>
                                    <p>Aenean leo ligula porttitor eu consequat vitae eleifend ac enim aliquam lorem
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4 mb-4">
                    <div class="col-lg-4">
                        <article class="featured-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-6.webp') }}" alt=""
                            ...
                            <div class="post-content">
                                <div class="category-meta">
                                    ...
                                    <div class="author-meta">
                                        <img src="{{ asset('images/person/person-f-13.webp') }}" alt=""
                                            class="author-img">
                    ...
                    <div class="col-lg-4">
                        <article class="featured-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-7.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
                                    ...
                                    <div class="author-meta">
                                        <img src="{{ asset('images/person/person-m-10.webp') }}" alt=""
                                            class="author-img">
                    ...
                    <div class="col-lg-4">
                        <article class="featured-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-5.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <article class="list-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-9.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <article class="list-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-10.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <article class="list-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-2.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <article class="list-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-1.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <article class="list-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-3.webp') }}" alt=""
                                    class="img-fluid" loading="lazy">
                            </div>
                            <div class="post-content">
                                <div class="category-meta">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
                    ...
                    <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
                        <img src="{{ asset('images/misc/misc-1.webp') }}" alt="Digital Platform"
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <article>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('images/person/person-f-12.webp') }}" alt=""
                    ...
                    <div class="col-lg-4">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('images/blog/blog-post-4.webp') }}" alt=""
                                    class="img-fluid">
                            </div>
